...
class AddOverhangsByProjectionFactorTest < Minitest::Test
  # def setup
  # end
  ...
  def test_add_overhangs_by_projection_factor_bad
  ...
  def test_add_overhangs_by_projection_factor_good
    # create an instance of the measure
    measure = AddOverhangsByProjectionFactor.new
    ...
    model.getSpaces.each do |space|
      if space.name.get =~ Regexp.new(/Space 101/) || space.name.get =~ Regexp.new(/Space 103/) || space.name.get =~ Regexp.new(/Space 104/)
  ...
  def test_add_overhangs_by_projection_factor_good_no_default
    # create an instance of the measure
    measure = AddOverhangsByProjectionFactor.new

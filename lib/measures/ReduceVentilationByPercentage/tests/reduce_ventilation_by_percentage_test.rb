...
class ReduceVentilationByPercentageTest < Minitest::Test
  def test_reduce_ventilation_by_percentage_01_bad_inputs
  ...
  def test_reduce_ventilation_by_percentage_02_high_inputs
    # create an instance of the measure
    measure = ReduceVentilationByPercentage.new
  ...
  def test_reduce_ventilation_by_percentage_04_space_type_no_costs
    # create an instance of the measure
    measure = ReduceVentilationByPercentage.new
  ...
  #   def test_reduce_ventilation_by_percentage_05_shared_resource
  #
  #     # create an instance of the measure
  #     measure = ReduceVentilationByPercentage.new
  #

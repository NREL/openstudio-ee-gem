...
class SetWaterHeaterEfficiencyHeatLossandPeakWaterFlowRate_Test < Test::Unit::TestCase
  # def setup
  # end
  ...
  def test_SetWaterHeaterEfficiencyHeatLossandPeakWaterFlowRate
    # create an instance of the measure
    measure = SetWaterHeaterEfficiencyHeatLossandPeakWaterFlowRate.new

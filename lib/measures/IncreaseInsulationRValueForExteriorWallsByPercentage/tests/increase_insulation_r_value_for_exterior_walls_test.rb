...
class IncreaseInsulationRValueForExteriorWallsByPercentageTest < Minitest::Test
  # def setup
  # end
  ...
  def test_increase_insulation_r_value_for_exterior_walls_by_percentage_new_construction

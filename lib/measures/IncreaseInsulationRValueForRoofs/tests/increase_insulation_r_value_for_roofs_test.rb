...
class IncreaseInsulationRValueForRoofsTest < Minitest::Test
  # def setup
  # end
  ...
  def test_increase_insulation_r_value_for_roofs_01_bad
  ...
  def test_increase_insulation_r_value_for_roofs_new_construction_fully_costed
    # create an instance of the measure
    measure = IncreaseInsulationRValueForRoofs.new
  ...
  def test_increase_insulation_r_value_for_roofs_retrofit_fully_costed
    # create an instance of the measure
    measure = IncreaseInsulationRValueForRoofs.new
  ...
  def test_increase_insulation_r_value_for_roofs_retrofit_no_cost
    # create an instance of the measure
    measure = IncreaseInsulationRValueForRoofs.new
  ...
  def test_increase_insulation_r_value_for_roofs_allow_reduction
    # create an instance of the measure
    measure = IncreaseInsulationRValueForRoofs.new

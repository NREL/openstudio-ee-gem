...
class ReduceSpaceInfiltrationByPercentageTest < Minitest::Test
  def test_reduce_space_infiltration_by_percentage_01_bad_inputs
    ...
    alter_coef = arguments[count += 1].clone
    assert(alter_coef.setValue(true))
    argument_map['alter_coef'] = alter_coef
  ...
  def test_reduce_space_infiltration_by_percentage_02_high_inputs
    # create an instance of the measure
    measure = ReduceSpaceInfiltrationByPercentage.new
  ...
  def test_reduce_space_infiltration_by_percentage_03_entire_building_fully_costed
    # create an instance of the measure
    measure = ReduceSpaceInfiltrationByPercentage.new
  ...
  def test_reduce_space_infiltration_by_percentage_03b_no_surfaces
    # create an instance of the measure
    measure = ReduceSpaceInfiltrationByPercentage.new
  ...
  def test_reduce_space_infiltration_by_percentage_04_space_type_no_costs
    # create an instance of the measure
    measure = ReduceSpaceInfiltrationByPercentage.new
  ...
  def test_reduce_space_infiltration_by_percentage_05_space_type_partial_cost
    # create an instance of the measure
    measure = ReduceSpaceInfiltrationByPercentage.new
  ...
  def test_reduce_space_infiltration_by_percentage_06_space_type_demo_initial_const
    # create an instance of the measure
    measure = ReduceSpaceInfiltrationByPercentage.new
  ...
  def test_reduce_space_infiltration_by_percentage_skip_coef
    # create an instance of the measure
    measure = ReduceSpaceInfiltrationByPercentage.new
    ...
    alter_coef = arguments[count += 1].clone
    assert(alter_coef.setValue(false))
    argument_map['alter_coef'] = alter_coef
    ...
    measure.run(model, runner, argument_map)
    result = runner.result
    puts 'test_ReduceSpaceInfiltrationByPercentage_skip_soef'
    show_output(result)
    assert(result.value.valueName == 'Success')
    # assert(result.info.size == 1)
    # assert(result.warnings.size == 1)

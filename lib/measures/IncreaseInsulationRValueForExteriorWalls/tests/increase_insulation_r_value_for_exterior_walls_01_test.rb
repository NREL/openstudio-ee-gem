...
class IncreaseInsulationRValueForExteriorWallsTest < Minitest::Test
  # def setup
  # end
  ...
  def test_increase_insulation_r_value_for_exterior_walls_01_bad
  ...
  def test_increase_insulation_r_value_for_exterior_walls_new_construction_fully_costed
    # create an instance of the measure
    measure = IncreaseInsulationRValueForExteriorWalls.new
  ...
  def test_increase_insulation_r_value_for_exterior_walls_retrofit_fully_costed
    # create an instance of the measure
    measure = IncreaseInsulationRValueForExteriorWalls.new
  ...
  def test_increase_insulation_r_value_for_exterior_walls_retrofit_no_cost
    # create an instance of the measure
    measure = IncreaseInsulationRValueForExteriorWalls.new
  ...
  def test_increase_insulation_r_value_for_exterior_walls_reverse_translated_model
    # create an instance of the measure
    measure = IncreaseInsulationRValueForExteriorWalls.new
  ...
  def test_increase_insulation_r_value_for_exterior_walls_empty_space_no_loads_or_surfaces
    # create an instance of the measure
    measure = IncreaseInsulationRValueForExteriorWalls.new
  ...
  def test_increase_insulation_r_value_for_exterior_walls__allow_reduction
    # create an instance of the measure
    measure = IncreaseInsulationRValueForExteriorWalls.new
  ...
  def test_increase_insulation_r_value_for_exterior_walls__no_mass
    # test file is 2.5.1

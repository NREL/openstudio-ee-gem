...
class ImproveMotorEfficiencyTest < Minitest::Test
  def test_improve_motor_efficiency_single_air_loop
  ...
  def test_improve_motor_efficiency_single_plant_loop
    # create an instance of the measure
    measure = ImproveMotorEfficiency.new
  ...
  def test_improve_motor_efficiency_all_loops
    # create an instance of the measure
    measure = ImproveMotorEfficiency.new

...
class ReduceLightingLoadsByPercentageTest < Minitest::Test
  # def setup
  # end
  ...
  def test_reduce_lighting_loads_by_percentage_01_bad_inputs
  ...
  def test_reduce_lighting_loads_by_percentage_02_high_inputs
    # create an instance of the measure
    measure = ReduceLightingLoadsByPercentage.new
  ...
  def test_reduce_lighting_loads_by_percentage_03_entire_building_fully_costed
    # create an instance of the measure
    measure = ReduceLightingLoadsByPercentage.new
  ...
  def test_reduce_lighting_loads_by_percentage_03b_no_surfaces_in_model
    # create an instance of the measure
    measure = ReduceLightingLoadsByPercentage.new
  ...
  def test_reduce_lighting_loads_by_percentage_04_space_type_no_costs
    # create an instance of the measure
    measure = ReduceLightingLoadsByPercentage.new
  ...
  def test_reduce_lighting_loads_by_percentage_05_space_type_partial_cost
    # create an instance of the measure
    measure = ReduceLightingLoadsByPercentage.new
  ...
  def test_reduce_lighting_loads_by_percentage_06_space_type_demo_initial_const
    # create an instance of the measure
    measure = ReduceLightingLoadsByPercentage.new
  ...
  def test_reduce_lighting_loads_by_percentage_07_ec
    # create an instance of the measure
    measure = ReduceLightingLoadsByPercentage.new

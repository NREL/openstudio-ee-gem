...
| `custom_door_cost_per_area` | Double | 0.0 | Custom door cost ($/ft^2) |
| `custom_bottom_seal_cost` | Double | 0.0 | Custom bottom seal cost ($/lf) |
| `custom_top_side_seal_cost` | Double | 0.0 | Custom top/side seal cost ($/lf) |

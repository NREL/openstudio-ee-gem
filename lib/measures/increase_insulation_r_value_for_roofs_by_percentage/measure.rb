...
class temp_class_0 < open_studio::Ruleset::model_user_script
  ...
  def arguments(model)
    ...
    r_value.set_display_name('Percentage Increase of R-value for Roof Insulation.')
  ...
  def run(model, runner, user_arguments)
    ...
    runner.register_final_condition("The existing insulation for roofs was increased by #{r_value}%. This was applied to #{neat_numbers(affected_area_ip, 0)} (ft^2) across #{final_string.size} roof constructions: #{final_string.sort.join(', ')}.")
...
Increase_insulation_r_value_for_roofs_by_percentage.new.register_with_application

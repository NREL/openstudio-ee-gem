...
class ImproveFanBeltEfficiencyTest < Minitest::Test
  def test_improve_fan_belt_efficiency_single_air_loop
  ...
  def test_improve_fan_belt_efficiency_single_plant_loop
    # create an instance of the measure
    measure = ImproveFanBeltEfficiency.new
  ...
  def test_improve_fan_belt_efficiency_all_loops
    # create an instance of the measure
    measure = ImproveFanBeltEfficiency.new

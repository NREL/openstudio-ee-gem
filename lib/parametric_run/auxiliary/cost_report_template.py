...
def build_report_html(
    ...
    num,
    max_energy_delta_gj,
    max_energy_delta_pct,
    max_energy_scenario,
    max_energy_savings_text,
    max_energy_savings_scenario,
    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="metric-box">
                ...
                <div class="chart-card">
                    <div class="chart-title">Total Site Energy Saving (Scenario - Baseline) (GJ/yr) Comparison</div>
                    <div class="bar-chart">
                        <div class="bar-row">
                            <div class="bar-label">Baseline</div>
                            <div class="bar-track"><div class="bar baseline" style="width: {baseline_energy_w:.1f}%;"></div></div>
                            <div class="bar-value">{num(b['total_site_energy_gj'])}</div>
                        </div>
                        <div class="bar-row">
                            <div class="bar-label">{max_energy_scenario}</div>
                            <div class="bar-track"><div class="bar retrofit" style="width: {best_energy_w:.1f}%;"></div></div>
                            <div class="bar-value">{num(max_energy_savings_row['total_site_energy_gj'])}</div>
                        </div>
                    </div>
                    <div class="legend">
                        <span class="legend-item"><span class="legend-swatch" style="background:#6c757d"></span>Baseline</span>
                        <span class="legend-item"><span class="legend-swatch" style="background:#28a745"></span>{max_energy_scenario}</span>
                    </div>
                    <p style="font-size:12px;color:#666;margin-top:8px;">Max saving: <span class="{max_energy_class}">{num(max_energy_delta_gj)} GJ ({num(max_energy_delta_pct)}%)</span></p>
                </div>
